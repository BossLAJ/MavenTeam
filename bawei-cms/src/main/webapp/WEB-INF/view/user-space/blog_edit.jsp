...
<html lang="zh-CN">
  ...
  <body>
				...
				<div class="panel panel-default">
				  <div class="panel-body">
                        ...
                        <p>
                         ...
                         <p id="terms">
                            <a  id="btn" class="btn btn-success btn-sm" >添加标签</a>
                        </p>
                        <p>
                        	<%-- <form> --%>
                            <input id="title" name="title" value="${blog.title}" class="form-control" placeholder="标题"/>
                            <input class="btn btn-success" type="button" value="B" onclick="b()">
                            <input class="btn btn-success" type="button" value="I" onclick="i()">
                            <input class="btn btn-success" type="button" value="R" onclick="r()">
                            <span class="red"></span>
                            <%-- </form> --%>
                        </p>
                        <p id="photo">
	...
	//点击添加标签按钮添加标签
    $("#btn").click(function(){
        $("#terms").append("<input class='form-control' name='name' /><br />");
    });
