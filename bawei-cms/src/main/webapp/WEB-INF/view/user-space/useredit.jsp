			...
			<div class="col-md-9">
				<div class="panel panel-default">
				  <div class="panel-body">
                        ...
                        <p>
                            <input name="mobil" value="${user.mobil}" class="form-control" placeholder="电话"/>
                            <span class="red"></span>
                        </p>
                        <p>
                        ...
                        <p>
                            <input name="xingzuo" value="${user.xingzuo}" class="form-control" placeholder="星座"/>
                            <span class="red"></span>
                        </p>
                        <p>
                            <input name="shiyan" value="${user.shiyan}" class="form-control" placeholder="誓言"/>
                            <span class="red"></span>
                        </p>
