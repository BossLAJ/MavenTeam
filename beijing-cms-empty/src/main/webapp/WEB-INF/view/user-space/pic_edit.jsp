...
<html lang="zh-CN">
  ...
  <body>
			...
			<div class="col-md-9">
				<div class="panel panel-default">
				  <div class="panel-body">
				    	<h1>发布图片</h1>
				    	<hr/>
				    	<form action="/my/picture/save" enctype="multipart/form-data" method="post" >
				    	...
				    	<p id="photo">
				    		<button type="button" class="btn btn-info" onclick="addphoto()">添加图片</button>
				    		<br/>
				    	</p>
				    	<p>
	...
	<script type="text/javascript">
		...
		function addphoto(){
			$("#photo").append("<br/><input type='file' name='pictures'/><br/><input type='text' name='desces' class='form-control' placeholder='图片描述'/>");
		}
	</script>
  </body>
</html>