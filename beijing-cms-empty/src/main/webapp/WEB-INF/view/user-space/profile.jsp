				  ...
				  <div class="panel-body">
				   	<h1>个人设置</h1>
				    	<hr/>
					    	...
					    	<p>
					    		<input name="mobil" value="${profile.mobil}" class="form-control" placeholder="电话"/>
					    		<span class="red"></span>
					    	</p>
					    	<p>
					    	...
					    	<p>
					    		<input name="xingzuo" value="${profile.xingzuo}" class="form-control" placeholder="星座"/>
					    		<span class="red"></span>
					    	</p>
					    	<p>
					    		<input name="shiyan" value="${profile.shiyan}" class="form-control" placeholder="誓言"/>
					    		<span class="red"></span>
					    	</p>
