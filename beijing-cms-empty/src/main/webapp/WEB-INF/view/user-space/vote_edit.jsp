...
<html lang="zh-CN">
  ...
  <body>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-3">
				<jsp:include page="/WEB-INF/inc/my_left.jsp"><jsp:param value="vote" name="module"/></jsp:include>
			</div>
			<div class="col-md-9">
				<div class="panel panel-default">
				  <div class="panel-body">
				    	<h1>发布投票</h1>
				    	<hr/>
				    	<form action="/my/vote/save" enctype="multipart/form-data" method="post" >
				    	...
				    	<p>
				    		<input name="title" value="${blog.title}" class="form-control" placeholder="投票标题"/>
				    		<span class="red"></span>
				    	</p>
				    	<p id="vote">
				    		<button type="button" class="btn btn-info" onclick="addVote()">添加投票选项</button>
				    		<br/>
				    	</p>
	...
	<script type="text/javascript">
		...
		function addVote(){
			$("#vote").append("<input type='text' name='optiones' class='form-control' placeholder='投票选项'/>");
		}
	</script>
  </body>
</html>