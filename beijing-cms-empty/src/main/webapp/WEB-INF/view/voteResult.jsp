				...
				<hr/>
					...
					<div class="content">
						...
						<p>
				    		<h4>${blog.title}</h4>
				    		<br/>
				    		<span class="red">投票结果：</span>
				    	</p>
						<p class="w-100" id="options">
							<c:forEach items="${optionXList }" var="opt">
								  <div class="progress">
								  		${opt.option}:&nbsp;&nbsp;&nbsp;&nbsp;
								  		<br/><br/><br/>
									  <div class="progress-bar" role="progressbar" aria-valuenow="${opt.count }" aria-valuemin="0" aria-valuemax="${sum }" style="width: 60%;">
									    ${opt.count }
									  </div>
								  </div>							   
							</c:forEach>		
